...
<!-- 
                ...
                <li>
                    <span title="Only Individual Level 5 can Add organization">
                    <a href="<?php echo base_url().'addorg'; ?>" class="waves-effect" <?php if($this->session->userdata('checkuser_opt')=='individual' && $this->session->userdata('level')=='5') { ?> style="pointer-events: default;" <?php }else{ ?> style="pointer-events: none;" <?php } ?> target="_blank" title="Add Organization">
                        <i class="bx bxs-buildings"></i><span class="badge rounded-pill bg-success float-end"></span>
                        Add Organization
                    </a>
                    </span>
                </li>
               ...
               <!-- <li>
                ...
                <li>
                    <span title="Only Individual Level 3,4,5 & organization can Add individual">
                    <a href="<?php echo base_url().'addindiv'; ?>" class="waves-effect" <?php if($this->session->userdata('checkuser_opt')=='organization' || ($this->session->userdata('checkuser_opt')=='individual' && ($this->session->userdata('level')=='5' || $this->session->userdata('level')=='4' || $this->session->userdata('level')=='3'))) { ?> style="pointer-events: default;" <?php }else{ ?> style="pointer-events: none;" <?php } ?> target="_blank" title="Add Individual">
               ...
               <!-- <li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="contacts-grid" key="t-user-grid">User Grid</a></li>
                        <li><a href="contacts-list" key="t-user-list">User List</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="auth-confirm-mail" key="t-confirm-mail">Confirm Mail</a></li>
                        <li><a href="auth-confirm-mail-2" key="t-confirm-mail-2">Confirm Mail 2</a></li>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li class="menu-title" key="t-menu">Certification</li>
                <li><a href="<?php echo base_url().'certlist/mdqm'; ?>" class="waves-effect" target="_blank">MDQM</a></li>
                <li><a href="<?php echo base_url().'certlist/qdp'; ?>" class="waves-effect" target="_blank">QDP</a><</li>
            </ul>
        </div>
        <!-- Sidebar -->
    </div>